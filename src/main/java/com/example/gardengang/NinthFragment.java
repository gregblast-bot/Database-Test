...
import com.example.gardengang.databinding.FragmentNinthBinding;
...
public class NinthFragment extends Fragment {
    ...
    private final String appid = "889fa9b3227b87ae16e454c832620369";
...
//        mAdView.loadAd(adRequest);
        ...
        etCountry = getView().findViewById(R.id.etCountry);
        tvResult = getView().findViewById(R.id.tvResult);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, tempUrl, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                double tempC = jsonObjectMain.getDouble("temp") - 273.15;
                                double feelsLikeC = jsonObjectMain.getDouble("feels_like") - 273.15;
                                double tempF = 1.8*tempC+32;
                                double feelsLikeF = 1.8*feelsLikeC+32;
                                float pressure = jsonObjectMain.getInt("pressure");
                                int humidity = jsonObjectMain.getInt("humidity");
                                JSONObject jsonObjectWind = jsonResponse.getJSONObject("wind");
                                double wind = jsonObjectWind.getDouble("speed");
                                double windy = 2.2369*wind;
                                ...
                                output += "Current weather of " + cityName + " (" + countryName + ")"
                                        ...
                                        + "\n -Temp: " + df.format(tempC) + " °C"
                                        + "\n -Feels Like: " + df.format(feelsLikeC) + " °C"
                                        + "\n -Humidity: " + humidity + "%"
                                        + "\n -Description: " + description
                                        + "\n -Wind Speed: " + wind + "m/s (meters per second)"
                                        + "\n -Wind Speed: " + df.format(windy) + "mph (miles per hour)"
                                        + "\n -Cloudiness: " + clouds + "%"
                                        + "\n -Pressure: " + pressure + " hPa";
                                tvResult.setText(output);

                                String hum = Integer.toString(humidity);
                                SharedViewModel.setHum(hum);

//                                //Not What I Wanted
//                                Bundle bundle = new Bundle();
//                                String hum = Integer.toString(humidity);
//                                bundle.putString("humidity", hum);
//                                Navigation.findNavController(view).navigate(R.id.SixthFragment, bundle);
