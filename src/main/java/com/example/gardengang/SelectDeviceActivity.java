...
public class SelectDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            Snackbar snackbar = Snackbar.make(view, "Activate Bluetooth or pair a Bluetooth device", Snackbar.LENGTH_LONG);
            snackbar.setAction("OK", view1 -> {
                // Move to back to bluetooth connection
                Intent intent = new Intent(SelectDeviceActivity.this, EighthFragment.class);
